...
export const CATALOGUE: Visualization[] = [
  ...
  { name: "Collision simulation", primitive: "mesh", needs: "geometry", spatial: "inherently", status: "needs-library", family: "Physics", note: "Needs a physics engine to produce the contacts; nothing here integrates motion." },
  { name: "Rigid body simulation", primitive: "mesh", needs: "geometry", spatial: "inherently", status: "needs-library", family: "Physics", note: "Needs a physics engine to produce the motion; nothing here integrates motion." },
  ...
  { name: "Exploded assembly", primitive: "mesh", needs: "geometry", spatial: "inherently", status: "primitive-missing", family: "Engineering", note: "Needs a per-part transform; the viewer draws one actor per file and holds no assembly tree." },
  { name: "Finite element analysis", primitive: "mesh", needs: "geometry", spatial: "inherently", status: "primitive-missing", family: "Engineering", note: "vtk.js reads the .vtp, but the mesh is drawn with no scalar range and no legend, so the field on it would not be readable." },
  { name: "Stress visualization", primitive: "mesh", needs: "geometry", spatial: "inherently", status: "primitive-missing", family: "Engineering", note: "vtk.js reads the .vtp, but the mesh is drawn with no scalar range and no legend, so the field on it would not be readable." },
  { name: "Strain visualization", primitive: "mesh", needs: "geometry", spatial: "inherently", status: "primitive-missing", family: "Engineering", note: "vtk.js reads the .vtp, but the mesh is drawn with no scalar range and no legend, so the field on it would not be readable." },
  { name: "Thermal analysis", primitive: "mesh", needs: "geometry", spatial: "inherently", status: "primitive-missing", family: "Engineering", note: "vtk.js reads the .vtp, but the mesh is drawn with no scalar range and no legend, so the field on it would not be readable." },
  ...
  { name: "Pressure distribution", primitive: "mesh", needs: "geometry", spatial: "inherently", status: "primitive-missing", family: "Engineering", note: "vtk.js reads the .vtp, but the mesh is drawn with no scalar range and no legend, so the field on it would not be readable." },
  { name: "Vibration analysis", primitive: "mesh", needs: "geometry", spatial: "inherently", status: "primitive-missing", family: "Engineering", note: "Mode shapes are a deformation per frequency; the viewer draws one static mesh and has no way to sweep them." },
  { name: "Modal analysis", primitive: "mesh", needs: "geometry", spatial: "inherently", status: "primitive-missing", family: "Engineering", note: "Same as vibration analysis: a mode per frequency, and no control to step through them." },
  { name: "Structural deformation", primitive: "mesh", needs: "geometry", spatial: "inherently", status: "primitive-missing", family: "Engineering", note: "Needs the displacement array applied to the geometry as a warp, which the mapper does not do." },
  ...
  { name: "Protein ligand interaction", primitive: "mesh", needs: "geometry", spatial: "inherently", status: "primitive-missing", family: "Chemistry", note: "Mol* draws the complex; detecting and marking the contacts is analysis this codebase does not do." },
