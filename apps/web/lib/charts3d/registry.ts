...
export const CATALOGUE: Visualization[] = [
  ...
  { name: "Finite element analysis", primitive: "mesh", needs: "geometry", spatial: "inherently", status: "specialist", family: "Engineering", viewer: "vtk", note: "The solved field on the mesh, as a .vtp: vtk.js draws the geometry and the array is painted over its own range with a legend." },
  { name: "Stress visualization", primitive: "mesh", needs: "geometry", spatial: "inherently", status: "specialist", family: "Engineering", viewer: "vtk", note: "A .vtp carrying stress per point, coloured over the array's own range with a legend to read it against." },
  { name: "Strain visualization", primitive: "mesh", needs: "geometry", spatial: "inherently", status: "specialist", family: "Engineering", viewer: "vtk", note: "As stress: a per-point array in a .vtp, painted over its measured range." },
  { name: "Thermal analysis", primitive: "mesh", needs: "geometry", spatial: "inherently", status: "specialist", family: "Engineering", viewer: "vtk", note: "Temperature per point in a .vtp, painted over its measured range." },
  ...
  { name: "Pressure distribution", primitive: "mesh", needs: "geometry", spatial: "inherently", status: "specialist", family: "Engineering", viewer: "vtk", note: "Pressure per point in a .vtp, painted over its measured range." },
