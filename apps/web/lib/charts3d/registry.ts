...
export const CATALOGUE: Visualization[] = [
  ...
  { name: "Gradient field", primitive: "glyphs", needs: "field", spatial: "inherently", status: "primitive-missing", family: "Mathematical" },
  { name: "Vector function", primitive: "glyphs", needs: "field", spatial: "inherently", status: "primitive-missing", family: "Mathematical" },
  { name: "Jacobian", primitive: "glyphs", needs: "field", spatial: "inherently", status: "primitive-missing", family: "Mathematical" },
  ...
  // 3. Vector and field -----------------------------------------------------
  { name: "3D vector field", primitive: "glyphs", needs: "field", spatial: "inherently", status: "primitive-missing", family: "Fields" },
  { name: "Arrow field", primitive: "glyphs", needs: "field", spatial: "inherently", status: "primitive-missing", family: "Fields" },
  ...
  { name: "Flow field", primitive: "glyphs", needs: "field", spatial: "inherently", status: "primitive-missing", family: "Fields" },
  { name: "Velocity field", primitive: "glyphs", needs: "field", spatial: "inherently", status: "primitive-missing", family: "Fields" },
  { name: "Acceleration field", primitive: "glyphs", needs: "field", spatial: "inherently", status: "primitive-missing", family: "Fields" },
  { name: "Force field", primitive: "glyphs", needs: "field", spatial: "inherently", status: "primitive-missing", family: "Fields" },
  { name: "Magnetic field", primitive: "glyphs", needs: "field", spatial: "inherently", status: "primitive-missing", family: "Fields" },
  { name: "Electric field", primitive: "glyphs", needs: "field", spatial: "inherently", status: "primitive-missing", family: "Fields" },
  { name: "Gravitational field", primitive: "glyphs", needs: "field", spatial: "inherently", status: "primitive-missing", family: "Fields" },
  { name: "Fluid flow", primitive: "glyphs", needs: "field", spatial: "inherently", status: "primitive-missing", family: "Fields" },
  { name: "Wind field", primitive: "glyphs", needs: "field", spatial: "inherently", status: "primitive-missing", family: "Fields" },
  ...
  { name: "Tensor field", primitive: "glyphs", needs: "field", spatial: "inherently", status: "primitive-missing", family: "Fields", note: "An ellipsoid glyph per sample rather than an arrow." },

  // 4. Volume ---------------------------------------------------------------
  { name: "Volume rendering", primitive: "volume", needs: "voxels", spatial: "inherently", status: "primitive-missing", family: "Volume" },
  { name: "Voxel plot", primitive: "volume", needs: "voxels", spatial: "inherently", status: "primitive-missing", family: "Volume" },
  ...
  { name: "Density volume", primitive: "volume", needs: "voxels", spatial: "inherently", status: "primitive-missing", family: "Volume" },
  { name: "Scalar field volume", primitive: "volume", needs: "voxels", spatial: "inherently", status: "primitive-missing", family: "Volume" },
  { name: "Temperature volume", primitive: "volume", needs: "voxels", spatial: "inherently", status: "primitive-missing", family: "Volume" },
  { name: "Pressure volume", primitive: "volume", needs: "voxels", spatial: "inherently", status: "primitive-missing", family: "Volume" },
  { name: "Seismic volume", primitive: "volume", needs: "voxels", spatial: "inherently", status: "primitive-missing", family: "Volume" },
  { name: "Atmospheric volume", primitive: "volume", needs: "voxels", spatial: "inherently", status: "primitive-missing", family: "Volume" },
  ...
  { name: "Classification regions", primitive: "volume", needs: "voxels", spatial: "inherently", status: "primitive-missing", family: "Machine learning" },
  { name: "Training trajectory", primitive: "lines", needs: "xyz", spatial: "inherently", status: "primitive-missing", family: "Machine learning" },
  { name: "Gradient flow", primitive: "glyphs", needs: "field", spatial: "inherently", status: "primitive-missing", family: "Machine learning" },
  { name: "Neural network graph", primitive: "network", needs: "graph", spatial: "framed", status: "primitive-missing", family: "Machine learning" },
  { name: "Transformer architecture", primitive: "network", needs: "graph", spatial: "framed", status: "primitive-missing", family: "Machine learning" },
  { name: "Attention graph", primitive: "network", needs: "graph", spatial: "framed", status: "primitive-missing", family: "Machine learning" },
  { name: "Model architecture graph", primitive: "network", needs: "graph", spatial: "framed", status: "primitive-missing", family: "Machine learning" },
  { name: "Activation visualization", primitive: "surface", needs: "grid", spatial: "framed", status: "configuration", family: "Machine learning" },

  // 7. Networks -------------------------------------------------------------
  { name: "3D network", primitive: "network", needs: "graph", spatial: "inherently", status: "primitive-missing", family: "Networks" },
  { name: "3D knowledge graph", primitive: "network", needs: "graph", spatial: "inherently", status: "primitive-missing", family: "Networks" },
  { name: "Citation network", primitive: "network", needs: "graph", spatial: "inherently", status: "primitive-missing", family: "Networks" },
  { name: "Research paper network", primitive: "network", needs: "graph", spatial: "inherently", status: "primitive-missing", family: "Networks" },
  { name: "Concept graph", primitive: "network", needs: "graph", spatial: "inherently", status: "primitive-missing", family: "Networks" },
  { name: "Dependency graph", primitive: "network", needs: "graph", spatial: "framed", status: "primitive-missing", family: "Networks" },
  { name: "Social network", primitive: "network", needs: "graph", spatial: "inherently", status: "primitive-missing", family: "Networks" },
  { name: "Biological interaction network", primitive: "network", needs: "graph", spatial: "inherently", status: "primitive-missing", family: "Networks" },
  { name: "Protein interaction network", primitive: "network", needs: "graph", spatial: "inherently", status: "primitive-missing", family: "Networks" },
  { name: "Gene interaction network", primitive: "network", needs: "graph", spatial: "inherently", status: "primitive-missing", family: "Networks" },
  { name: "Neural connectivity", primitive: "network", needs: "graph", spatial: "inherently", status: "primitive-missing", family: "Networks" },
  { name: "Supply chain network", primitive: "network", needs: "graph", spatial: "framed", status: "primitive-missing", family: "Networks" },
  { name: "Computer network", primitive: "network", needs: "graph", spatial: "framed", status: "primitive-missing", family: "Networks" },
  { name: "Communication network", primitive: "network", needs: "graph", spatial: "framed", status: "primitive-missing", family: "Networks" },
  { name: "Hierarchical network", primitive: "network", needs: "graph", spatial: "framed", status: "primitive-missing", family: "Networks" },
  { name: "Temporal network", primitive: "network", needs: "graph", spatial: "inherently", status: "primitive-missing", family: "Networks", note: "A graph whose edges appear and vanish over time." },
  ...
  { name: "Weather visualization", primitive: "glyphs", needs: "field", spatial: "inherently", status: "primitive-missing", family: "Geographic" },
  { name: "Wind visualization", primitive: "glyphs", needs: "field", spatial: "inherently", status: "primitive-missing", family: "Geographic" },
  { name: "Ocean currents", primitive: "glyphs", needs: "field", spatial: "inherently", status: "primitive-missing", family: "Geographic" },
  { name: "Geological layers", primitive: "volume", needs: "voxels", spatial: "inherently", status: "primitive-missing", family: "Geographic" },
  { name: "Seismic visualization", primitive: "volume", needs: "voxels", spatial: "inherently", status: "primitive-missing", family: "Geographic" },
  ...
  { name: "Shipping network", primitive: "network", needs: "graph", spatial: "inherently", status: "primitive-missing", family: "Geographic" },
  ...
  { name: "Electromagnetic field", primitive: "glyphs", needs: "field", spatial: "inherently", status: "primitive-missing", family: "Physics" },
  { name: "Fluid simulation", primitive: "glyphs", needs: "field", spatial: "inherently", status: "primitive-missing", family: "Physics" },
  { name: "Turbulence", primitive: "glyphs", needs: "field", spatial: "inherently", status: "primitive-missing", family: "Physics" },
  { name: "Heat transfer", primitive: "volume", needs: "voxels", spatial: "inherently", status: "primitive-missing", family: "Physics" },
  { name: "Stress field", primitive: "glyphs", needs: "field", spatial: "inherently", status: "primitive-missing", family: "Physics" },
  { name: "Pressure field", primitive: "volume", needs: "voxels", spatial: "inherently", status: "primitive-missing", family: "Physics" },
  { name: "Quantum probability", primitive: "volume", needs: "voxels", spatial: "inherently", status: "primitive-missing", family: "Physics" },
  ...
  { name: "CFD visualization", primitive: "glyphs", needs: "field", spatial: "inherently", status: "primitive-missing", family: "Engineering" },
  { name: "Airflow", primitive: "glyphs", needs: "field", spatial: "inherently", status: "primitive-missing", family: "Engineering" },
  ...
  { name: "Kinematic chain", primitive: "network", needs: "graph", spatial: "inherently", status: "primitive-missing", family: "Engineering" },
  { name: "Vehicle simulation", primitive: "mesh", needs: "geometry", spatial: "inherently", status: "needs-library", family: "Engineering" },
  { name: "Aerodynamics", primitive: "glyphs", needs: "field", spatial: "inherently", status: "primitive-missing", family: "Engineering" },
  ...
  { name: "Electron density", primitive: "volume", needs: "voxels", spatial: "inherently", status: "primitive-missing", family: "Chemistry" },
  ...
  { name: "Reaction pathway", primitive: "network", needs: "graph", spatial: "framed", status: "primitive-missing", family: "Chemistry" },
  { name: "Chemical bond network", primitive: "network", needs: "graph", spatial: "inherently", status: "primitive-missing", family: "Chemistry" },
  ...
  { name: "Brain connectivity", primitive: "network", needs: "graph", spatial: "inherently", status: "primitive-missing", family: "Medical" },
  ...
  { name: "Tissue volume", primitive: "volume", needs: "voxels", spatial: "inherently", status: "primitive-missing", family: "Medical" },
  ...
  { name: "Biological pathway network", primitive: "network", needs: "graph", spatial: "framed", status: "primitive-missing", family: "Medical" },
  { name: "Gene expression space", primitive: "points", needs: "xyz", spatial: "inherently", status: "built", family: "Medical" },
  { name: "Protein network", primitive: "network", needs: "graph", spatial: "inherently", status: "primitive-missing", family: "Medical" },
  ...
  { name: "Dark matter distribution", primitive: "volume", needs: "voxels", spatial: "inherently", status: "primitive-missing", family: "Astronomy" },
  ...
  { name: "Time-varying volume", primitive: "volume", needs: "voxels", spatial: "inherently", status: "primitive-missing", family: "Time", animated: true },
  { name: "Dynamic network", primitive: "network", needs: "graph", spatial: "inherently", status: "primitive-missing", family: "Time", animated: true },
  ...
  { name: "Risk heat volume", primitive: "volume", needs: "voxels", spatial: "inherently", status: "primitive-missing", family: "Financial" },
  ...
  { name: "Provenance tree", primitive: "network", needs: "graph", spatial: "framed", status: "primitive-missing", family: "Native", note: "How a result was made. The lineage already exists." },
  ...
  { name: "Evidence galaxy", primitive: "network", needs: "graph", spatial: "inherently", status: "primitive-missing", family: "Native" },
  { name: "Knowledge constellation", primitive: "network", needs: "graph", spatial: "inherently", status: "primitive-missing", family: "Native" },
  { name: "Hypothesis space", primitive: "network", needs: "graph", spatial: "inherently", status: "primitive-missing", family: "Native" },
  { name: "Experiment universe", primitive: "points", needs: "xyzv", spatial: "inherently", status: "configuration", family: "Native" },
  { name: "Causal graph space", primitive: "network", needs: "graph", spatial: "inherently", status: "primitive-missing", family: "Native" },
  { name: "Analysis pipeline space", primitive: "network", needs: "graph", spatial: "framed", status: "primitive-missing", family: "Native" },
  { name: "AI reasoning workspace", primitive: "network", needs: "graph", spatial: "framed", status: "primitive-missing", family: "Native" },
  ...
  { name: "Simulation chamber", primitive: "volume", needs: "voxels", spatial: "inherently", status: "primitive-missing", family: "Native" },
